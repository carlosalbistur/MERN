                                        ...
                                        this.state.tasks.map(task => {
                                            return (
                                                <tr key = {task._id}>
                                                    ...
                                                    <td>
                                                        <button className="btn ligth - blue darken-4" onClick={() => this.deleteTask(task._id)}>
                                                            <i className="material-icons">delete</i>
                                                        </button>
                                                        <button className="btn ligth - blue darken-4" onClick={() => this.editTask(task._id)} style={{margin: '4px'}}>
